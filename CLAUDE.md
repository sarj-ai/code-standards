...
Consumer configuration is generated by `sarj-standards`; do not hand-copy or
...
writes the row `sarj-standards doctor` reads; update the strict preset, the
shipped `eslint.strict.mjs`, run `sarj-standards maintain docs sync`, and update
