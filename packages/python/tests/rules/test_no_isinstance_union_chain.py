...
_PUBLIC_EXAMPLES = NoIsinstanceUnionChain.public_examples()


@pytest.mark.parametrize("example", _PUBLIC_EXAMPLES, ids=tuple(e.example_id for e in _PUBLIC_EXAMPLES))
def test_public_documentation_examples_are_executable(example: RuleExample) -> None:
    focus = example.focus_file
    assert len(NoIsinstanceUnionChain().check(Path(focus.path), focus.source)) == example.expected_count
...
def test_ignores_classes_local_to_an_unrelated_function_scope():
    src = """
def make():
    class Foo: ...
    class Bar: ...
...
def test_flags_chain_over_classes_local_to_the_same_function_scope():
    src = """
def handle(x):
    class Foo: ...
    class Bar: ...
...
def test_flags_chain_over_classes_from_an_enclosing_function_scope():
    src = """
def outer():
    class Foo: ...
    class Bar: ...
...
def test_ignores_generated_source() -> None:
    source = """
