      ...
      "no-restricted-imports": [
        "error",
        {
          paths: [
            ...
            {"message": "LIB101: The application profile standardizes HTTP clients on Ky; review errors, retries, hooks, and response parsing. Replace with ky.", "name": "request"},
            {"message": "LIB101: The application profile standardizes HTTP clients on Ky; review errors, retries, hooks, and response parsing. Replace with ky.", "name": "node-fetch"},
            {"message": "LIB101: The application profile standardizes HTTP clients on Ky; review errors, retries, hooks, and response parsing. Replace with ky.", "name": "cross-fetch"},
            {"message": "LIB101: The application profile standardizes HTTP clients on Ky; review errors, retries, hooks, and response parsing. Replace with ky.", "name": "isomorphic-fetch"},
            {"message": "LIB101: The application profile standardizes HTTP clients on Ky; review errors, retries, hooks, and response parsing. Replace with ky.", "name": "axios"},
            {"message": "LIB102: The application profile standardizes date utilities on date-fns; migration is not API-compatible. Replace with date-fns.", "name": "moment"},
            {"message": "LIB102: The application profile standardizes date utilities on date-fns; migration is not API-compatible. Replace with date-fns.", "name": "dayjs"},
            {"message": "LIB103: The application profile standardizes collection utilities on Remeda and native APIs. Replace with remeda.", "name": "lodash"},
            {"message": "LIB103: The application profile standardizes collection utilities on Remeda and native APIs. Replace with remeda.", "name": "lodash-es"},
            {"message": "LIB103: The application profile standardizes collection utilities on Remeda and native APIs. Replace with remeda.", "name": "underscore"},
            {"message": "LIB104: Use clsx for conditional class-name composition. Replace with clsx.", "name": "classnames"},
            {"message": "LIB105: The application profile standardizes runtime validation on Zod; schemas are not drop-in compatible. Replace with zod.", "name": "joi"},
            {"message": "LIB105: The application profile standardizes runtime validation on Zod; schemas are not drop-in compatible. Replace with zod.", "name": "yup"},
            {"message": "LIB105: The application profile standardizes runtime validation on Zod; schemas are not drop-in compatible. Replace with zod.", "name": "superstruct"},
            {"message": "LIB105: The application profile standardizes runtime validation on Zod; schemas are not drop-in compatible. Replace with zod.", "name": "io-ts"},
            {"message": "LIB105: The application profile standardizes runtime validation on Zod; schemas are not drop-in compatible. Replace with zod.", "name": "runtypes"},
            {"message": "LIB106: Use jose; review key formats and async signing and verification APIs. Replace with jose.", "name": "jsonwebtoken"},
            {"message": "LIB107: The application profile standardizes servers on Hono; Node deployments also need @hono/node-server. Replace with hono.", "name": "express"},
            {"message": "LIB107: The application profile standardizes servers on Hono; Node deployments also need @hono/node-server. Replace with hono.", "name": "koa"},
            {"message": "LIB108: The application profile standardizes tests on Vitest; review globals, timers, mocks, and environment setup. Replace with vitest.", "name": "jest"},
            {"message": "LIB108: The application profile standardizes tests on Vitest; review globals, timers, mocks, and environment setup. Replace with vitest.", "name": "mocha"},
            {"message": "LIB109: Use Vitest spies, mocks, and fake timers instead of Sinon. Replace with Vitest mocks.", "name": "sinon"},
            {"message": "LIB110: The application profile standardizes command-line interfaces on citty. Replace with citty.", "name": "commander"},
            {"message": "LIB110: The application profile standardizes command-line interfaces on citty. Replace with citty.", "name": "yargs"},
            ...
            {"message": "LIB115: The application profile standardizes environment loading on @dotenvx/dotenvx. Replace with @dotenvx/dotenvx.", "name": "dotenv"},
          ...
          patterns: [
            ...
            {"group": ["request/*"], "message": "LIB101: The application profile standardizes HTTP clients on Ky; review errors, retries, hooks, and response parsing. Replace with ky."},
            {"group": ["node-fetch/*"], "message": "LIB101: The application profile standardizes HTTP clients on Ky; review errors, retries, hooks, and response parsing. Replace with ky."},
            {"group": ["cross-fetch/*"], "message": "LIB101: The application profile standardizes HTTP clients on Ky; review errors, retries, hooks, and response parsing. Replace with ky."},
            {"group": ["isomorphic-fetch/*"], "message": "LIB101: The application profile standardizes HTTP clients on Ky; review errors, retries, hooks, and response parsing. Replace with ky."},
            {"group": ["axios/*"], "message": "LIB101: The application profile standardizes HTTP clients on Ky; review errors, retries, hooks, and response parsing. Replace with ky."},
            {"group": ["moment/*"], "message": "LIB102: The application profile standardizes date utilities on date-fns; migration is not API-compatible. Replace with date-fns."},
            {"group": ["dayjs/*"], "message": "LIB102: The application profile standardizes date utilities on date-fns; migration is not API-compatible. Replace with date-fns."},
            {"group": ["lodash/*"], "message": "LIB103: The application profile standardizes collection utilities on Remeda and native APIs. Replace with remeda."},
            {"group": ["lodash-es/*"], "message": "LIB103: The application profile standardizes collection utilities on Remeda and native APIs. Replace with remeda."},
            {"group": ["underscore/*"], "message": "LIB103: The application profile standardizes collection utilities on Remeda and native APIs. Replace with remeda."},
            {"group": ["classnames/*"], "message": "LIB104: Use clsx for conditional class-name composition. Replace with clsx."},
            {"group": ["joi/*"], "message": "LIB105: The application profile standardizes runtime validation on Zod; schemas are not drop-in compatible. Replace with zod."},
            {"group": ["yup/*"], "message": "LIB105: The application profile standardizes runtime validation on Zod; schemas are not drop-in compatible. Replace with zod."},
            {"group": ["superstruct/*"], "message": "LIB105: The application profile standardizes runtime validation on Zod; schemas are not drop-in compatible. Replace with zod."},
            {"group": ["io-ts/*"], "message": "LIB105: The application profile standardizes runtime validation on Zod; schemas are not drop-in compatible. Replace with zod."},
            {"group": ["runtypes/*"], "message": "LIB105: The application profile standardizes runtime validation on Zod; schemas are not drop-in compatible. Replace with zod."},
            {"group": ["jsonwebtoken/*"], "message": "LIB106: Use jose; review key formats and async signing and verification APIs. Replace with jose."},
            {"group": ["express/*"], "message": "LIB107: The application profile standardizes servers on Hono; Node deployments also need @hono/node-server. Replace with hono."},
            {"group": ["koa/*"], "message": "LIB107: The application profile standardizes servers on Hono; Node deployments also need @hono/node-server. Replace with hono."},
            {"group": ["jest/*"], "message": "LIB108: The application profile standardizes tests on Vitest; review globals, timers, mocks, and environment setup. Replace with vitest."},
            {"group": ["mocha/*"], "message": "LIB108: The application profile standardizes tests on Vitest; review globals, timers, mocks, and environment setup. Replace with vitest."},
            {"group": ["sinon/*"], "message": "LIB109: Use Vitest spies, mocks, and fake timers instead of Sinon. Replace with Vitest mocks."},
            {"group": ["commander/*"], "message": "LIB110: The application profile standardizes command-line interfaces on citty. Replace with citty."},
            {"group": ["yargs/*"], "message": "LIB110: The application profile standardizes command-line interfaces on citty. Replace with citty."},
            ...
            {"group": ["dotenv/*"], "message": "LIB115: The application profile standardizes environment loading on @dotenvx/dotenvx. Replace with @dotenvx/dotenvx."},
        ...
        { libraries: [
            {
              "id": "LIB101",
              "module": "request",
              "note": "The application profile standardizes HTTP clients on Ky; review errors, retries, hooks, and response parsing.",
              "replacement": "ky"
            },
            {
              "id": "LIB101",
            ...
            },
            {
              "id": "LIB102",
              "module": "moment",
              "note": "The application profile standardizes date utilities on date-fns; migration is not API-compatible.",
            ...
            },
            {
              "id": "LIB103",
              "module": "lodash",
              "note": "The application profile standardizes collection utilities on Remeda and native APIs.",
              "replacement": "remeda"
            },
            {
              "id": "LIB103",
            ...
            },
            {
              "id": "LIB105",
              "module": "joi",
              "note": "The application profile standardizes runtime validation on Zod; schemas are not drop-in compatible.",
              "replacement": "zod"
            },
            {
              "id": "LIB105",
            ...
            },
            {
              "id": "LIB107",
              "module": "express",
              "note": "The application profile standardizes servers on Hono; Node deployments also need @hono/node-server.",
              "replacement": "hono"
            },
            {
              "id": "LIB107",
            ...
            },
            {
              "id": "LIB108",
              "module": "jest",
              "note": "The application profile standardizes tests on Vitest; review globals, timers, mocks, and environment setup.",
              "replacement": "vitest"
            },
            {
              "id": "LIB108",
            ...
            },
            {
              "id": "LIB110",
              "module": "commander",
              "note": "The application profile standardizes command-line interfaces on citty.",
              "replacement": "citty"
            },
            {
              "id": "LIB110",
            ...
            },
            {
              "id": "LIB115",
              "module": "dotenv",
              "note": "The application profile standardizes environment loading on @dotenvx/dotenvx.",
