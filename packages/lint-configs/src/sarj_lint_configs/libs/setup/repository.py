...
from sarj_lint_configs.libs.adoption.lifecycle import Command, execute
from sarj_lint_configs.libs.repository import hooks
...
def plan_setup(root: Path) -> SetupPlan:
    ...
    commands = (
        *(
            ...
            for name in ("python", "sql", "iac", "lint-configs")
        ),
        Command(
            "TypeScript package",
