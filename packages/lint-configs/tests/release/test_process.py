...
from sarj_lint_configs.libs.release import ProcessResult, credential_free_environment, run_build_process
...
def test_build_process_isolates_posix_and_windows_config_homes(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("sarj_lint_configs.libs.release.process.run_process_environment", run)
