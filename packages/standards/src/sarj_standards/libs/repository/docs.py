...
_EXECUTABLE_OR_LEGAL_DOCUMENTS: Final = (Path("AGENTS.md"),)
...
def _root_readme(
    ...
    sections = [
        ...
        (
            ...
            "breadth-first node indexing, parent lookup, import resolution, and generated-file detection across rules "
            "for one file. Use `context.parents.get(node)` to find a node's parent without rebuilding a map. "
            ...
            "Native Python directory inputs prune dependency and cache trees before scanning them, and return "
            "files in sorted order. Explicit file arguments retain their supplied order.\n\n"
