...
EXACT_CONFIG_RESTATEMENT_CASES = (
    ...
    EvaluationCase(
        "internal-string-whitespace-differs",
        Language.CONFIG,
        '# Banner is hello world\nbanner = "hello  world"\n',
        ExpectedOutcome.NO_MATCH,
        PurePosixPath("config.toml"),
    ),
    EvaluationCase(
        "toml-basic-multiline-string-payload",
        Language.CONFIG,
        'template = """\n# Retry count is 3\nretry_count = 3\n"""\n',
        ExpectedOutcome.NO_MATCH,
        PurePosixPath("config.toml"),
    ...
    EvaluationCase(
        "toml-literal-multiline-string-payload",
        Language.CONFIG,
        "template = '''\n# Retry count is 3\nretry_count = 3\n'''\n",
        ExpectedOutcome.NO_MATCH,
        PurePosixPath("config.toml"),
...
def test_generated_header_exclusion_preserves_only_commented_out_config(tmp_path: Path) -> None:
    path = tmp_path / "workflow.yml"
    path.write_text(
        "# Code generated by ConfigTool.\n# DO NOT EDIT.\n\n"
        "# old_name: old\n# old_image: app\n\n"
